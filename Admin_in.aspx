<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_in.aspx.cs" Inherits="projet_fin_etude_asp.Admin_in" %>
   ...
   <li><a href="Admin_in.aspx" style="text-decoration:none;">Les Etudiants</a> </li>
    <li><a href="Admin_in_prof.aspx" style="text-decoration:none;">Les Professeurs</a></li>
        ...
        <div style="margin-left:340px; margin-top:80px">
            <br />
            &nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label1" runat="server" Text="Num_Etudiant :"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;
            <br class="auto-style1" />
&nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label2" runat="server" Text="Nom_Etudiant :"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br />
            &nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label3" runat="server" Text="Num_Specialite :"></asp:Label>
&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
