<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Etudiant.aspx.cs" Inherits="projet_fin_etude_asp.Etudiant" %>
<!DOCTYPE html>
...
<body>
  ...
  <div class="carousel-inner" >
    ...
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/learning-3245792_1920.jpg" alt="Second slide" height="577" />
          <div class="carousel-caption">
            <p><a class="btn btn-primary" href="Connecte.aspx" role="button">Connecte-vous</a></p>
        </div>
    </div>
    <div class="carousel-item" >
      <img class="d-block w-100" src="images/school-2761394_1920.jpg" alt="Third slide" height="577" />
          <div class="carousel-caption">
            <p><a class="btn btn-primary" href="Connecte.aspx" role="button">Connecte-vous</a></p>
        </div>
    </div>
